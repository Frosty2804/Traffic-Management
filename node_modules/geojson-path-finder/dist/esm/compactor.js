 ...
 * @returns
 */
export default function compactGraph(sourceVertices, vertexCoords, sourceEdgeData, options = {}) {
    const result = {
...
export function compactNode(key, vertices, ends, vertexCoords, edgeData, trackIncoming, options = {}) {
